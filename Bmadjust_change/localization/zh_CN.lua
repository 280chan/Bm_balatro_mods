return {
    descriptions={
        Back={
            ...
            b_green={
                ...
                text={
                    "在回合结束时：",
                    "每剩一次{C:blue}出牌次数获得{C:money}$#1#{s:0.85}",
                    "每剩一次{C:red}弃牌次数获得{C:money}$#2#{s:0.85}",
        ...
        Joker={
            ...
            j_drivers_license={
                ...
                text={
                    ...
                    "{C:attention}16张增强卡牌",
                    "则{X:mult,C:white} X#1# {}倍率",
                    "{C:inactive}（当前为{C:attention}#2#{C:inactive}张）",
                },
                unlock={
                    "增强牌组里",
                    "{E:1,C:attention}#1#{}张卡牌",
            ...
            j_green_joker={
                name="绿色小丑",
                text={
                    "每次出牌这张小丑牌{C:mult}+#1#{}倍率",
                    "每次弃牌这张小丑牌{C:mult}-#2#{}倍率",
                    "{C:inactive}（当前为{C:mult}+#3#{C:inactive}倍率）",
                },
            },
            j_gros_michel={
            ...
            j_madness={
                name="疯狂",
                text={
                    "在选择{C:attention}小盲注{}或{C:attention}大盲注{}后",
                    "这张小丑牌获得{X:mult,C:white}X#1#{}倍率",
                    "并且随机{C:attention}摧毁{}一张小丑牌",
                    "{C:inactive}（当前为{X:mult,C:white}X#2#{}{C:inactive}倍率）",
                },
            },
            j_mail={
            ...
            j_throwback={
                ...
                text={
                    "本赛局内每跳过一次",
                    "{C:attention}盲注{}则获得{X:mult,C:white}X#1#{}倍率",
                    "跳过时有{C:green}#3#/#4#{}的几率",
                    "底注{C:attention}-1{}",
                    "{C:inactive}（当前为{X:mult,C:white} X#2# {C:inactive}倍率）",
                },
                unlock={
        ...
        Other={
            ...
            remove_negative={
                name="n",
                text={
                    "{C:inactive,s:0.9}（保留复制牌的{C:dark_edition,s:0.9}负片{C:inactive,s:0.9}）",
                },
            },
            rental={
                name="租用",
        ...
        Stake={
            ...
            stake_gold={
                ...
                text={
                    ...
                    "{C:inactive,s:0.8}（售价为$1且每回合花费{C:money,s:0.8}$3{C:inactive,s:0.8}）",
                    "{s:0.8}之前所有赌注也都起效",
                },
            },
            stake_green={
        ...
        Voucher={
            ...
            v_illusion={
                ...
                text={
                    ...
                    "可能是{C:enhanced}增强牌{}",
                    "或带有{C:dark_edition}版本{}和{C:attention}蜡封{}",
                },
                unlock={
                    "在商店",
                    "购买总计",
    ...
    misc={
        ...
        dictionary={
            ...
            ph_blind_score_reduce="盲注至少得分削弱！",
